package jdev.mentorialojavirtual.model;
...
public class CupDesc  implements Serializable{
	...
	public Date getDataValidadeDesc() {
		return dataValidadeDesc;
	}

	public void setDataValidadeDesc(Date dataValidadeDesc) {
		this.dataValidadeDesc = dataValidadeDesc;
	}
